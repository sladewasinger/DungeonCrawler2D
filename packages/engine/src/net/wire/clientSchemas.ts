...
export const clientDebugSchema = z.object({ type: z.literal("debug"), op: z.enum(["teleport", "god", "noclip"]), x: z.number().optional(), y: z.number().optional(), on: z.boolean().optional() });
