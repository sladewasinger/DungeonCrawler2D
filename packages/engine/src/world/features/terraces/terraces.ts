...
import { hasPlatformCluster, type WorldChunkCoordinate } from "../platforms/platforms.js";
import { generatedChunkCenter, seedsFor, type CorridorSegment } from "../../core/terrain.js";
import { GENERATION_CHUNK_SIZE as CHUNK_SIZE } from "../../generate/layout/scale.js";
import { carveTerraceEntries, type TerraceRect } from "./entries.js";
