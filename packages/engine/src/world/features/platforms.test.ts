...
import { PLATFORM_TIER_STEP, hasPlatformCluster, platformLootSpots } from "./platforms.js";
import { CORRIDOR_HALF_WIDTH, chunkCenter, corridorSegments, distToCorridor } from "../terrain.js";
