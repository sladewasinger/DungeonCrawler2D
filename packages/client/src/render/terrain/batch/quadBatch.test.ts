...
import {
  TerrainQuadBatchRenderer,
  type TerrainBatchMaterials,
  type TerrainScreenProjection,
} from "./quadBatch.js";
...
describe("TerrainQuadBatchRenderer", () => {
  it("clears and submits each planner batch as Phaser 4 Graphics triangles", () => {
    const graphics = new RecordingGraphics();
    const renderer = new TerrainQuadBatchRenderer(graphics as unknown as Phaser.GameObjects.Graphics);
...
const screenProjection: TerrainScreenProjection = {
