...
import { createCameraFollowState, type CameraFollowState } from "../camera/cameraFollow.js";
import { createProjectileVelocityState, type ProjectileVelocityState } from "../player/projectileVelocity.js";
import { createSelfCosmeticsState, type SelfCosmeticsState } from "../player/selfCosmetics.js";
import { createWallBumpState, type WallBumpState } from "../../../input/gestures/wallBump.js";
import {
  createFrameEntityBuckets,
  type FrameEntityBuckets,
} from "../frame/frameEntityBuckets.js";
import {
  createFrameEntityViews,
  type FrameEntityViews,
} from "../entities/frameEntityViews.js";
import type { SelfPose, SelfVitals } from "../entities/entityViews.js";
import type { MeleeSwingSpawn } from "../combat/meleeSwingEvents.js";
