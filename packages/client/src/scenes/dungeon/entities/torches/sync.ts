// Wires live torch entities into terrain entity views, baked terrain lighting, and
// dynamic accent halos.
...
/**
 * One frame's torch handling: builds entity views, updates the baked tile-light seeds
 * when a torch lands or expires, and returns halo/flame accent lights.
 */
