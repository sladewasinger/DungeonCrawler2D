...
export interface HudFakeSnapshot {
  ...
  respawnRemainingSec: number; giveUpHoldProgress: number; downedRemainingSec: number; reviveProgress: number; reviverName: string | null;
...
export function fakeHudSnapshot(downed: boolean): HudFakeSnapshot {
  return {
    ...
    downed,
    dead: false,
    respawnRemainingSec: 5, giveUpHoldProgress: 0.55, downedRemainingSec: 15, reviveProgress: 0, reviverName: null,
