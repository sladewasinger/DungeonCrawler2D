...
export interface PlayerSlot extends AdminPlayerState {
  ...
  god: boolean;
  /** Live admin-character traversal mode, authoritative and replicated. */
  noclip?: boolean;
  /** Optional incoming-damage grant; name/admin resolution lives in handicap.ts. */
  handicap?: HandicapGrant;
  /** One-shot authoritative artifact sent with the first snapshot after descent. */
  pendingFiniteFloorArtifact?: string;
...
export interface SimState {
  ...
  /** Encoded destination floor owned by FloorRegistry; never generated by a client. */
